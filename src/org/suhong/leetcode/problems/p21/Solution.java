...
//    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("======================");
        ListNode result1 = s.mergeTwoLists(listNode11, listNode12);
        while (result1 != null) {
        ...
        System.out.println("======================");
        ListNode result2 = s.mergeTwoLists(listNode21, listNode22);
        while (result2 != null) {
        ...
        System.out.println("======================");
        ListNode result3 = s.mergeTwoLists(listNode31, listNode32);
        while (result3 != null) {
